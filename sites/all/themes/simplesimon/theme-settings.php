...
/**
 * USAGE:
 * 1 - To use this file replace "simplesimon" with the name of
...
// Replace 'simplesimon' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function simplesimon_form_system_theme_settings_alter(&$form, &$form_state)  {
